        ...
        <div className='flex items-center gap-2 w-full'>
         ...
         <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          <div className='flex flex-col w-full'>
            ...
            <div className='flex flex-col w-full'>
            <label>Model</label>
            <input type="text" placeholder='e.g. X5, E-Class, M4...'
            required className='px-3 py-2 mt-1 border border-bordercolor rounded-md outline-none'
         ...
         <div className='flex flex-col w-full'>
          ...
          {/*-description--**/}
            ...
            <textarea rows={5} placeholder='Describe your car, its condition, and any notable details...'
            required className='px-3 py-2 mt-1 border border-bordercolor rounded-md outline-none'
